...
#Définition du personnage du jeu
def ball(x,y):
...
smallText10 = pygame.font.Font("freesansbold.ttf",20)
textSurf10, textRect10 = text_objects("START", smallText10)
textRect10.center = ( (150+(120/2)),(380+(60/2)))
...
def gameover():
    ...
    smallText1 = pygame.font.Font("freesansbold.ttf",20)
    textSurf1, textRect1 = text_objects("RESTART", smallText1)
    ...
    smallText2 = pygame.font.Font("freesansbold.ttf",20)
    textSurf2, textRect2 = text_objects("EXIT", smallText2)
...
#Texte de copyrights
    ...
    text2 = fontt.render('FIBO © Copyrights 2016', True, black)
